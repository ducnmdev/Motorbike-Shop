    ...
    return (
        < aside className="w-96 border-r border-gray-200 p-6" >
            ...
            <nav className="space-y-4">
                <div className='my-2'>
                    <Link to="/account/profile" className="no-underline text-black">
                ...
                {currentPath.startsWith('/account/profile') && (
                    <ul className="ml-2 my-2 text-sm space-y-2 text-red-600">
                        <li className="">Thông tin tài khoản</li>
                    </ul>
                )}
                <div className='my-2'>
                    <Link to="/account/orders/motorcycle" className="no-underline text-black">
                        <div className='flex items-center'>
                ...
                {currentPath.startsWith('/account/orders') && (
                    <ul className="ml-2 my-2 text-sm space-y-2">
                        <li>
                            <Link
                                to="/account/orders/motorcycle"
                                className={currentPath === '/account/orders/motorcycle' ? 'text-red-600' : ''}>
                                Xe máy
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                className={currentPath === '/account/orders/accessory-sparepart' ? 'text-red-600' : ''}>
                                Phụ tùng/Phụ kiện
                            </Link>
                        </li>
                    </ul>
                ...
                <div className='my-2'>
                    <Link to="/account/settings" className="no-underline text-black">
                        <div className='flex items-center'>
