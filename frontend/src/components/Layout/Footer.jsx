...
function Footer() {
    return (
        <footer className='relative z-[50]'> 
            <section className='bg-neutral-900 py-16 lg:px-16'>
                <div className='grid grid-cols-1 gap-8 lg:grid-cols-2 xl:grid-cols-4 xl:gap-16'>
                    <div className='col-span-1 flex flex-col gap-4'>
                        ...
                        <p className='font-vietnam text-sm text-neutral-400 md:text-base'>
                    ...
                    <div className='col-span-1 flex flex-col gap-4'>
                        ...
                        <ul className='flex flex-col font-vietnam  text-sm text-neutral-400 sm:text-base md:text-lg gap-2 p-0 m-0'>
                    ...
                    <div className='col-span-1 flex flex-col gap-4'>
                        ...
                        <ul className='flex flex-col text-sm sm:text-base md:text-lg gap-2 p-0 m-0'>
                            <li><Link className='font-vietnam text-neutral-400 no-underline transition-colors hover:text-[#de0000]' to='/xe-may'>Xe máy</Link></li>
                            <li><Link className='font-vietnam text-neutral-400 no-underline transition-colors hover:text-[#de0000]' to='/phu-kien'>Phụ tùng và Phụ kiện</Link></li>
                        </ul>
                    </div>
                    <div className='col-span-1 flex flex-col gap-4'>
                        <p className='font-vietnam text-xl font-bold text-white uppercase md:text-2xl m-0'>Chi nhánh</p>
                        <ul className='flex flex-col font-vietnam  text-sm text-neutral-400 sm:text-base md:text-lg gap-2 p-0 m-0'>
                            <li className='flex'><img className='w-5 h-5 m-2' src={location_icon} alt="lo_ic" />Quận Tây Hồ, Thành phố Hà Nội, Việt Nam</li>
                            <li className='flex'><img className='w-5 h-5 m-2 mt-1' src={phone_icon} alt="ph_ic" />0944882003</li>
                        </ul>
                    </div>
                </div>
            </section>
